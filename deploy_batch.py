...
def parse_args():
    ...
    parser.add_argument('img', help='image directory containing images used to convert model')
    parser.add_argument(
        '--test-img',
        default=None,
        type=str,
        help='image dir containing test images to be used to test model')
    parser.add_argument(
        '--work-dir',
        default=os.getcwd(),
...
#     batched_tensor = torch.stack(images)
#     return batched_tensor
def get_batch_images(directory):
...
def main():
    ...
    # ZEN
    # Load images and create a batched tensor
    batched_imgs = get_batch_images(args.img)
    batched_test_imgs = get_batch_images(args.test_img)
    ...
    create_process(
        ...
        args=(model_cfg_path, deploy_cfg_path, backend_files, batched_test_imgs,
              args.device),
        kwargs=extra,
        ret_value=ret_value)
